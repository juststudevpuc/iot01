...
print("---------------------------------------")
print("✅ System Online: Auto-Close (10s) Active")
print("---------------------------------------")
...
def sync_to_web(state_str):
    ...
    try:
        ...
        print(f"📡 Web Updated: {state_str}")
    except:
        print("⚠️ Web Sync Failed")

# --- 4. CORE DOOR LOGIC (WITH AUTO-CLOSE) ---
